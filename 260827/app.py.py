...
# ------------------------------------------------------------
# Sidebar controls
# PERIOD UI FIX: Analysis Years slider -> NSGAConfig.years
# Existing sliders/controls are preserved unchanged.
# ------------------------------------------------------------
st.markdown(
    """
    <div class="hero-box">
...
with st.sidebar:
    ...
    analysis_years = st.slider("Analysis Years", min_value=1, max_value=20, value=5, step=1, help="분석기간(년). 변경 시 기간 수요, DT 누적, 비용 및 Ao 산출에 함께 반영됩니다.")
